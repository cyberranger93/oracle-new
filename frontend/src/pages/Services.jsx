...
import { Building2, Hammer, Briefcase, ClipboardList, CheckCircle, ArrowRight } from 'lucide-react';
...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Comprehensive general contracting services delivering quality construction projects from groundbreaking to completion.',
              ...
              return (
                ...
                >
                  <div className={isEven ? 'order-1' : 'order-2'}>
                    ...
                    <Link
                      to="/contact"
                      className="inline-flex items-center px-6 py-3 bg-[#D4AF37] text-white rounded-md hover:bg-[#C19A2B] transition-all btn-transition font-semibold"
                    >
                      Get a Quote
